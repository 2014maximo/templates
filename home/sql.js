        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="row m-3">
                    ...
                    <div class="col bg-Sql rot-1 l-menu"><a href="componentes/SQL/sql_003.html">CONSULTAS</a></div>
                    <div class="col bg-Sql rot-2 l-menu"><a href="componentes/SQL/sql_004.html">INSTALACIÓN MOTORES</a></div>
                </div>
            </div>
            <div class="col-md-1"></div>
        </div>
