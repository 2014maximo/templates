        ...
        <div class="row flex-lg-row-reverse">
          ...
          <div class="col-lg-8" data-aos="flip-left">
              ...
              <div class="p-4 d-flex justify-content-around align-items-center text-center drop" style="background-image: url('./styles/assets/categorias/tablaMenu1.png');background-repeat: no-repeat;background-size: cover;">
                ...
                <div class="linkCategoria" onClick="menuUno('linuxmint', '80%')">
                  <img src="styles/assets/categorias/linuxmint.png" alt="" width="auto" height="80" class="drop">
                </div>
              </div>
    
              <div class="p-4 d-flex justify-content-around align-items-center text-center drop" style="background-image:url('./styles/assets/categorias/tablaMenu1.png');background-repeat:no-repeat;background-size:cover;">
                <div class="linkCategoria" onClick="menuUno('debian', '80%')">
                  <img src="styles/assets/categorias/debian.png" alt="" width="auto" height="80" class="drop">
                </div>
                <div class="linkCategoria" onClick="menuUno('visual_studio_code', '80%')">
                  <img src="styles/assets/categorias/visual_studio_code_text_white.png" alt="" width="auto" height="80" class="drop">
                </div>
              ...
              <div class="p-1 d-flex justify-content-around align-items-center text-center drop" style="background-image:url('./styles/assets/categorias/tablaMenu1.png');background-repeat:no-repeat;background-size:cover;">
                ...
                <div class="linkCategoria" onClick="menuUno('git', '80%')">
                  <img src="styles/assets/categorias/git-light.png" alt="" width="auto" height="60" class="drop">
                </div>
                <div class="linkCategoria" onClick="menuUno('java', '80%')">
                  <img src="styles/assets/categorias/logo-java.png" alt="" width="auto" height="115" class="drop">
                </div>
              </div>
          </div>
        </div>
